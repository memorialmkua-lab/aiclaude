...
- add-new-skill: Adds a new skill to the repository, following the SKILL.md format and conventions.
- add-new-agent: Adds a new agent to the repository, including registration and documentation updates.
