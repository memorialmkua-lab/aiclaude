...
- add-documentation-command-or-workflow: Adds documentation for a new command or workflow to the project.
- add-documentation-skill-or-agent: Adds documentation for a new skill or agent to the project.
