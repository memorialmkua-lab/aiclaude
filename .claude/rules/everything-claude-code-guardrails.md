...
- add-new-skill-command: Adds a new skill command to the ECC bundle, documenting how to add new skills.
- add-new-agent-command: Adds a new agent command to the ECC bundle, documenting how to add new agents.
