...
- add-command-or-skill-or-agent-or-workflow: Adds a new command, skill, agent, or workflow to the ECC system by creating or updating the relevant markdown documentation.
- add-team-or-identity-or-research-config: Adds or updates team configuration, identity, or research playbook files for the ECC system.
