...
- add-new-skill-command: Adds a new skill command to the ECC bundle, documenting the process or command for adding new skills.
- add-new-agent-command: Adds a new agent command to the ECC bundle, documenting the process or command for adding new agents.
