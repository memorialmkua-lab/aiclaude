...
- add-new-skill-or-agent: Adds a new skill or agent to the system, including documentation and configuration.
- add-command-or-workflow-doc: Adds or updates documentation for commands or workflows, including feature development, database migration, and agent/skill addition.
